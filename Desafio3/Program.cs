...
public class Saudacao
{
    ...
    {
        // FEITO: Implemente a lógica para criar uma saudação personalizada usando o nome armazenado.
        // Dica: utilize interpolação de strings para incluir o nome na mensagem final.

        string saudacao = $"Bem-vindo, {nomeCliente}!";
        
        return saudacao; // Retorne a mensagem formatada corretamente aqui
    }
}
